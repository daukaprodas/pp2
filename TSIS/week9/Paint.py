...
class ButtonPen(GameObject):
    def __init__(self):
        self.size = 40
        self.pen = pygame.transform.scale(pygame.image.load("images/penbuttonimages.png"),(40,40))
...
class ButtonRightTriangle(GameObject):
    def __init__(self):
        self.size = 40
        self.pen = pygame.transform.scale(pygame.image.load("images/righttriangle.png"),(40,40))
        self.rect = pygame.draw.rect(
            SCREEN,
            (0, 0, 0),
            (
...
class ButtonEraser(GameObject):
    def __init__(self):
        self.size = 40
        self.pen = pygame.transform.scale(pygame.image.load("images/eraserbutton.png"),(40,40))
        self.rect = pygame.draw.rect(
            SCREEN,
            (0, 0, 0),
            (
...
class ButtonRombus(GameObject):
    def __init__(self):
        self.size = 40
        self.pen = pygame.transform.scale(pygame.image.load("images/rombus.png"),(40,40))
        self.rect = pygame.draw.rect(
            SCREEN,
            (0, 0, 0),
            (
...
class ButtonEquileiteral(GameObject):
    def __init__(self):
        self.size = 40
        self.pen = pygame.transform.scale(pygame.image.load("images/equileiteral.png"),(40,40))
        self.rect = pygame.draw.rect(
            SCREEN,
            (0, 0, 0),
            (
